...
export async function fetchDashboardOrders(): Promise<DashboardOrder[]> {
  await delay(600);
  return [
    { id: 'ORD-1001', customer: 'Ayesha Khan', status: 'completed', amount: 240, date: '2026-09-10' },
    ...
    { id: 'ORD-1005', customer: 'Fatima Noor', status: 'completed', amount: 310, date: '2026-09-14' },
  ];
}
